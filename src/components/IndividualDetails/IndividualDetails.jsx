...
const IndividualDetails = () => {
    ...
    return (
        ...
        <div className='w-11/12 mx-auto'>
            ...
            <div className='bg-gray-100 rounded-lg px-42 py-5 text-center shadow-lg mt-5 mb-5'>
                <h1 className='text-3xl font-bold mb-3'>Lawyer’s Profile Details</h1>
                <p>Experience: {bestlawyer.experience} years in corporate law and dispute resolution Practice Areas: Business law, contract negotiations, intellectual property, litigation Qualifications: LL.B from University of Dhaka, LL.M in International Business Law Achievements: Successfully handled high-profile corporate mergers, recognized as a top legal strategist in Bangladesh <br /> Available day: 
            ...
            <div className="card card-side bg-base-100 shadow-lg mb-5">
                ...
                <div className="card-body">
                    ...
                    <div>
                        <div className='flex items-center gap-3'>
                                         Availability:{<div className=" flex gap-3 list-disc list-inside">
                                    {bestlawyer.availability?.map((slot, index) => (
                                <ul className='bg-yellow-50 text-yellow-500 border-2 border-amber-600 px-3 py-1 rounded-3xl' key={index}>{slot}</ul>
                            ))}
                            </div>} 
                        </div>
                    ...
                    <div>
                        <p>Consultation Fee: <span className='text-green-500 font-bold'>Taka: {bestlawyer.consultation_fee}</span> </p>
                    </div>
                    ...
                    <div>
                        <div>
                            {(() => {
                                ...
                                const isAvailable = bestlawyer.availability?.includes(todayName);
                                return (
                                <ul className='bg-green-200 text-green-500 px-3 py-1 rounded-3xl'>
                                    {isAvailable ? 'Lawyer Available Today' : 'Lawyer Not Available Today'}
                                </ul>
                                );
                            })()}
                            </div>
